#summary This page describes how to install cinfony 0.9.x on Linux

_For information on installing cinfony 0.8.x, please see InstallationOnLinuxV08_
...
## cinfony ##
  ...
  * Download and install [cinfony 0.9](http://cinfony.googlecode.com/files/cinfony-0.9.tar.gz)
...
OpenBabel is a C++ library and can be accessed from both CPython and Jython.
  ...
  * Download and extract **[OpenBabel](http://openbabel.org/wiki/Install)** 2.2.2
...
In the following section $OB\_SRCDIR refers to the directory where OpenBabel was extracted and compiled (something like /home/user/Tools/openbabel-2.2.2), and $OB\_INSTALLDIR refers to the directory where it was installed (typically /usr/local/lib).
...
The RDKit is a C++ library currently accessible only from CPython.
  ...
  * Download and extract **[RDKit](http://rdkit.googlecode.com/files/RDKit_Q22009_1.tgz)** Q22009\_1
  * Follow the [installation instructions](http://code.google.com/p/rdkit/wiki/BuildingOnLinux)
  * Add the `RDKit_Q22009_1` directory to the PYTHONPATH environment variable
  * Test at the Python prompt as follows:
```
...
The CDK is a Java library and can be accessed from both CPython and Jython.
  ...
  * Download **[CDK](http://sourceforge.net/projects/cdk/files/cdk/cdk-1.2.3.jar/download)** 1.2.3
  * Add the `cdk.1.2.3.jar` file to your CLASSPATH environment variable (remember to include the full path to the jar file)
